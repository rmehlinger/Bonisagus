    ...
    R.div {class: 'row'}, [
      ...
      R.div {class: 'col-sm-4'}, [
        ...
        R.div {class: 'row'}, bind ->
          ...
          if virtues.length <= 6 then R.ul {class: "list-unstyled col-sm-12"},
          ...
          ].map (list) -> R.ul {class: "col-sm-6 list-unstyled"},
      ...
      R.div {class: 'col-sm-4'}, [
        ...
        R.div {class: 'row'}, bind ->
          ...
          if flaws.length <= 6 then R.div {class: 'col-sm-12'},
